...
namespace Holtz_Academy.API.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            {
                Student s1 = new Student("STUDENT 1", DateTime.Now, "STREET S1", "NEIGHBORHOOD S1", 1000, "CITY NAME S1", 1, 1);
                Student s2 = new Student("STUDENT 2", DateTime.Now, "STREET S2", "NEIGHBORHOOD S2", 2000, "CITY NAME S2", 1, 1);
                Student s3 = new Student("STUDENT 3", DateTime.Now, "STREET S3", "NEIGHBORHOOD S3", 3000, "CITY NAME S3", 9, 1);
                Student s4 = new Student("STUDENT 4", DateTime.Now, "STREET S4", "NEIGHBORHOOD S4", 4000, "CITY NAME S4", 9, 1);
                Student s5 = new Student("STUDENT 5", DateTime.Now, "STREET S5", "NEIGHBORHOOD S5", 5000, "CITY NAME S5", 6, 1);
                Student s6 = new Student("STUDENT 6", DateTime.Now, "STREET S6", "NEIGHBORHOOD S6", 6000, "CITY NAME S6", 2, 1);
                Student s7 = new Student("STUDENT 7", DateTime.Now, "STREET S7", "NEIGHBORHOOD S7", 7000, "CITY NAME S7", 2, 1);
                Student s8 = new Student("STUDENT 8", DateTime.Now, "STREET S8", "NEIGHBORHOOD S8", 8000, "CITY NAME S8", 3, 1);
                Student s9 = new Student("STUDENT 9", DateTime.Now, "STREET S9", "NEIGHBORHOOD S9", 9000, "CITY NAME S9", 4, 1);
                Student s10 = new Student("STUDENT 10", DateTime.Now, "STREET S10", "NEIGHBORHOOD S10", 10000, "CITY NAME S10", 9, 1);
                Student s11 = new Student("STUDENT 11", DateTime.Now, "STREET S11", "NEIGHBORHOOD S11", 11000, "CITY NAME S11", 8, 1);
                Student s12 = new Student("STUDENT 12", DateTime.Now, "STREET S12", "NEIGHBORHOOD S12", 12000, "CITY NAME S12", 7, 1);
                Student s13 = new Student("STUDENT 13", DateTime.Now, "STREET S13", "NEIGHBORHOOD S13", 13000, "CITY NAME S13", 6, 1);
                Student s14 = new Student("STUDENT 14", DateTime.Now, "STREET S14", "NEIGHBORHOOD S14", 14000, "CITY NAME S14", 5, 1);
                Student s15 = new Student("STUDENT 15", DateTime.Now, "STREET S15", "NEIGHBORHOOD S15", 15000, "CITY NAME S15", 4, 1);
